      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" role="navigation">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="./games">比赛</a></li>
    ...
    <div class="bs-docs-header" id="content">
      <div class="container" style="padding-top:20px;padding-bottom:60px;">
          ...
          <div class="col-md-12">
          	<div class="col-md-2">
          		<!-- 球队头像高100px -->
	        	<img src="${homeTeamPicture }"  style="float:right" alt="湖人">
          	</div>
          	<div class="col-md-8">
          	...
          	<div class="col-md-2"> 
          		<!-- 球队头像大小选择100px -->
	        	<img src="${guestTeamPicture }"  style="float:left" alt="火箭">
          	</div>
          </div>
          <!-- <div class="col-md-1"></div> -->
      	</div>
